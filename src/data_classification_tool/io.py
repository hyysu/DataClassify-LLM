...
def flatten_result(result: AnalysisResult) -> dict[str, object]:
    ...
    return {
        ...
        "rule_category_level1": result.grading.rule_category_level1,
        "rule_category_level2": result.grading.rule_category_level2,
        ...
        "risk_tags": " | ".join(result.grading.risk_tags),
        "matched_rules": " | ".join(result.grading.matched_rules),
        "legal_basis": " | ".join(result.grading.legal_basis),
